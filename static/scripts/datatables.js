 ...
 *   https://datatables.net/download/#bs5/dt-2.0.5/b-3.0.2/fh-4.0.1/r-3.0.2
 *
 * Included libraries:
 *   DataTables 2.0.5, Buttons 3.0.2, FixedHeader 4.0.1, Responsive 3.0.2
 */
...
(function( factory ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		builder: "bs5/dt-2.0.5/b-3.0.2/fh-4.0.1/r-3.0.2",
